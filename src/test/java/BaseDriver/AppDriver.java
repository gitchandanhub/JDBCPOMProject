	     ...
	     @BeforeTest
	      public void Initialize() throws Exception {
	    	 DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");  
	    	  ...
	    	  htmlreporter = new ExtentHtmlReporter("C:\\Users\\cchauhan\\git\\ictleasingne\\ExtentReport\\Executionresult.html");
	    	  //htmlreporter = new ExtentHtmlReporter(config.getProperty("ExtentReport_path")+"Steriaresult"+dtf.format(now)+".html");
	    	     ...
	    	     htmlreporter.config().setTheme(Theme.STANDARD);      
	    	      ...
	    	      extentreport.setSystemInfo("Organization", "ActLeasing");    
	    	    extentreport.attachReporter(htmlreporter);    
	    	  FileInputStream fis = new FileInputStream("C:\\Users\\cchauhan\\git\\ictleasingne\\src\\test\\java\\Property\\config.properties");
	    	  config.load(fis);
